...
// This file was generated by github.com/kat-co/wadl2go on 2015-03-16 via the command:
// wadl2go --to-file="./autogenerated_client.go" --wadl-file="$HOME/workspace/openstack-api-site/api-ref/src/wadls/volume-api/src/v2/volume-api-v2.wadl" --package-name="cinder"
