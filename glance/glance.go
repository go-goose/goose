...
func (c *Client) ListImages() ([]Image, error) {
	...
	if err != nil {
		return nil, errors.Newf(err, nil, "failed to get list of images")
	}
...
func (c *Client) ListImagesDetail() ([]ImageDetail, error) {
	...
	if err != nil {
		return nil, errors.Newf(err, nil, "failed to get list of image details")
	}
	return resp.Images, nil
}
...
func (c *Client) GetImageDetail(imageId string) (*ImageDetail, error) {
	...
	if err != nil {
		return nil, errors.Newf(err, nil, "failed to get details of imageId: %s", imageId)
	}
